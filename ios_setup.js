...
function correctSearchPaths(next) {
  ...
  rctfbsdkProject.parse(function(err) {
    ...
    rctfbsdkProject.updateBuildProperty(
...
function updateFBSDKFrameworks(next) {
  ...
  myProj.parse(function(err) {
    ...
    myProj.addFramework("./ios/Frameworks/FBSDKCoreKit.framework", {
      customFramework: true,
      target: target,
      link: true
    });
    myProj.addFramework("./ios/Frameworks/FBSDKShareKit.framework", {
      customFramework: true,
      target: target,
      link: true
    });
    myProj.addFramework("./ios/Frameworks/FBSDKLoginKit.framework", {
      customFramework: true,
      target: target,
      link: true
    });
